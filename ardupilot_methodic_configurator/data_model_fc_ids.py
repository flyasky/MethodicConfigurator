...
# Maps 16-bit APJ board ID to board name(s) for 315 supported boards
...
# Maps 16-bit APJ board ID to board vendor for 315 supported boards
...
# Maps 16-bit APJ board ID to MCU series for 315 supported boards
...
# Maps MCU series to 16-bit APJ board ID for 315 supported boards

...
# Maps 16-bit APJ board ID to board name(s) for 318 supported boards
APJ_BOARD_ID_NAME_DICT: dict[int, list[str]] = {
    ...
    1156: ["CBU-H7-Stamp"],
    7130: ["CoreWingF405WingV2"],
    7131: ["CoreWingF405WMiniV2"],
    1187: ["CORVON405V2_1"],
    1189: ["CORVON743V1"],
    1229: ["CORVON743V2"],
    1211: ["CORVON_V5"],
...
# Maps 16-bit APJ board ID to board vendor for 318 supported boards
APJ_BOARD_ID_VENDOR_DICT: dict[int, list[str]] = {
    ...
    7130: ["ArduPilot"],  # CoreWingF405WingV2
    7131: ["ArduPilot"],  # CoreWingF405WMiniV2
    ...
    1220: ["ArduPilot"],  # X-MAV-AP-H743v3
    ...
    5740: ["ArduPilot"],  # ZenFC743
    5600: ["ArduPilot"],  # ZeroOneX6, ZeroOneX6_Air
}

# Maps 16-bit APJ board ID to MCU series for 318 supported boards
APJ_BOARD_ID_MCU_SERIES_DICT: dict[int, list[str]] = {
    ...
    7130: ["STM32F4xx"],  # CoreWingF405WingV2
    7131: ["STM32F4xx"],  # CoreWingF405WMiniV2
    ...
    1220: ["STM32H7xx"],  # X-MAV-AP-H743v3
